...
export default class LungVesselROI {
    ...
    enableLungVesselROI() {
        ...
        // (주: Renderer 레벨의 sortObjects = true가 기본으로 활성화됨)
        ...
        // === Margin 메시 투명도 설정 ===
        // margin이 들어간 모든 메시들의 opacity를 0.3으로 설정
        const allMeshes = [
            ...this.lungVesselMeshes,
            ...this.nodulesExceptionMeshes,
            ...this.otherMeshes
        ...
        allMeshes.forEach((mesh) => {
            ...
            if (meshName.includes("margin")) {
                ...
                console.log(`[ROI] Margin mesh "${mesh.name}" opacity set to 0.3`);
            }
        });
    ...
    disableLungVesselROI() {
        ...
        console.log("LungVesselROI disabled - all meshes restored to original state");
    }
